...
function King (){
    return(
        ...
        <div className="flex flex-1 border"> A Premier healthcare provider dedicated to delivering exceptional patient care, innovative treatments and compasionate service to our community
            ...
            individual, from routine check-ups to complex medical procedures
             our team of experienced  nurses are dedicated to delivering personalized care with compassion and empathy </div>
        ...
        <div className="flex flex-1   p-4 -mt-8">Improve Community Health: Develope outreach programs and partnerships to promote health and wellness in the community     </div>
        <div className="flex flex-1   p-4 -mt-8">Enhance patient health: Encourage patient participation in care decisions and hospital operations   </div>
