...
function Eye (){
    return(
        <div className="flex flex-col bg-gradient-to-tr from-blue-600 via-white  ">
            <div className="flex-1 justify-center  flex"><b> Eye Unit</b></div>
           <div className="flex    ">
              
              
            <div className="flex-1  flex  flex-col "><img src={p29} alt="p29" className="absolute inset-0 object-cover w-full 
        h-90 -z-10 group-hover:opacity-50"/></div>
             ...
             priortize eye care for a better future</div>  <div className="flex-1 justify-center flex flex-col  items-center gap-3 "> <p>See a Opthalmologist</p>
             <div ><input type="text" placeholder="name" className=" border  hover:bg-white rounded-md justify-center" 
         /></div>
             ...
             <div><input type="Next of kin" placeholder="Next of kin" className="border  hover:bg-white rounded-md" /></div>
             <div><input type="Your problem" placeholder="your problem" className="border  hover:bg-white rounded-md" /></div>
             <div className="inline  "><button className=" flex-grow-0 hover:bg-gray-50  !w-20"><b>Submit</b></button></div>
             </div>
        </div>
             
            <div className="flex-1 h-90 flex flex-col "><img src={p902} alt="p902" /></div>
